// HoldButton do React Bits (https://reactbits.dev), variante TypeScript + CSS.
...
// Só é chamada dentro de handlers e rAF, nunca durante o render
  ...
  return (
    ...
    >
      ...
      <span id={hintId} className="hold-button__sr">
        Pressione e segure por {Math.round(holdTime / 100) / 10} segundos para confirmar
      </span>
    </button>
  );
};
